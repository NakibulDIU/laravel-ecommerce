...
<table style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif;">
  ...
  <tbody>
    ...
    <tr style="border-bottom: 1px solid #ddd;">
      ...
      <td style="padding: 12px;"><a href="{{ route('admin.updatecategory',$category->id) }}" style="color: green" onclick="return confirm('Are you sure?')"> Update </a><a href="{{ route('admin.categorydelete',$category->id) }}" onclick="return confirm('Are you sure? you want to delete this category')"> Delete</a></td>
